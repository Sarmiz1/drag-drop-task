      ...
      >
        ...
        <div className="flex-1 flex flex-col bg-white">
            ...
            {activeTab === "Profile" ? (
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <input
                      type="text"
                      defaultValue="Samuel Joseph"
                      className="w-full bg-gray-50 border-none rounded-xl px-4 py-3 text-gray-800 font-medium focus:ring-2 focus:ring-blue-500 outline-none"
                    />
                  </div>
                  <div className="space-y-2">
                    <label className="text-xs font-bold text-gray-400 uppercase tracking-wider">
                    ...
                    <input
                      type="email"
                      defaultValue="sarmiz@example.com"
                      className="w-full bg-gray-50 border-none rounded-xl px-4 py-3 text-gray-800 font-medium focus:ring-2 focus:ring-blue-500 outline-none"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <textarea
                    rows={4}
                    className="w-full bg-gray-50 border-none rounded-xl px-4 py-3 text-gray-800 text-sm focus:ring-2 focus:ring-blue-500 outline-none resize-none"
              ...
              <div className="flex flex-col items-center justify-center h-full text-center space-y-4">
                ...
                <p className="text-gray-400 max-w-xs">
                  We're working hard to bring you {activeTab.toLowerCase()}{" "}
          ...
          <div className="p-8 border-t border-gray-50 flex justify-end gap-3">
            ...
            <button className="px-8 py-3 rounded-xl bg-blue-600 text-white font-bold hover:bg-blue-700 shadow-lg shadow-blue-200 transition-all active:scale-95">
              Save Changes
            </button>
          </div>
        </div>
