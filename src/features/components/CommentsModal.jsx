...
const CommentsModal = ({ isOpen, onClose, taskTitle, comments = [], onAddComment }) => {
    ...
    >
      ...
      >
        <div className="flex flex-col h-[500px]">
          ...
          {/* Footer Input */}
          <form onSubmit={handleSubmit} className="p-6 border-t border-gray-50 bg-gray-50/50">
            <div className="relative">
              ...
              />
              <button type="submit" className="absolute right-2 top-1/2 -translate-y-1/2 p-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-all active:scale-95 shadow-lg shadow-blue-200">
                <Send size={18} />
              </button>
            </div>
          </form>
